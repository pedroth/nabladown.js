define("ace/mode/doc_comment_highlight_rules", [
  ...
  define("ace/mode/javascript_highlight_rules", [
    ...
    function r(e) {
      ...
      (this.$rules = {
        ...
        function_arguments: [
          { token: "variable.parameter", regex: l },
          { token: "punctuation.operator", regex: "[, ]+" },
          { token: "punctuation.operator", regex: "$" },
          { token: "empty", regex: "", next: "no_regex" }
        ],
    ...
    a.inherits(r, s), (t.JavaScriptHighlightRules = r);
  }),
      ...
      function () {
        (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
          ...
          (this.getFoldWidgetRange = function (e, t, n, o) {
            ...
            if ("markbegin" !== t && (a = r.match(this.foldingStopMarker))) {
              i = a.index + a[0].length;
              return a[1]
                ? this.closingBracketBlock(e, a[1], n, i)
          ...
          (this.getSectionRange = function (e, t) {
            ...
            return new c(r, a, i, e.getLine(i).length);
          }),
          (this.getCommentRegionBlock = function (e, t, n) {
            ...
            if (a < n) return new c(a, o, n, t.length);
          });
      }.call(a.prototype);
  }),
  ...
  define("ace/mode/behaviour/xml", [
    ...
    "use strict";
    function m(e, t) {
      return e && -1 < e.type.lastIndexOf(t + ".xml");
    }
    function o() {
      this.add("string_dquotes", "insertion", function (e, t, n, o, r) {
        if ('"' == r || "'" == r) {
          var a = r,
            i = o.doc.getTextRange(n.getSelectionRange());
          if ("" !== i && "'" !== i && '"' != i && n.getWrapBehavioursEnabled())
            return { text: a + i + a, selection: !1 };
          var s = n.getCursorPosition(),
            l = o.doc.getLine(s.row).substring(s.column, s.column + 1),
            u = new p(o, s.row, s.column),
            c = u.getCurrentToken();
          if (l == a && (m(c, "attribute-value") || m(c, "string")))
            return { text: "", selection: [1, 1] };
          if (!(c = c || u.stepBackward())) return;
          for (; m(c, "tag-whitespace") || m(c, "whitespace"); )
            c = u.stepBackward();
          var g = !l || l.match(/\s/);
          if (
            (m(c, "attribute-equals") && (g || ">" == l)) ||
            (m(c, "decl-attribute-equals") && (g || "?" == l))
          )
            return { text: a + a, selection: [1, 1] };
        }
      }),
        ...
        this.add("autoclosing", "insertion", function (e, t, n, o, r) {
          if (">" == r) {
            var a = n.getSelectionRange().start,
              i = new p(o, a.row, a.column),
              s = i.getCurrentToken() || i.stepBackward();
            if (
              !s ||
              !(
                m(s, "tag-name") ||
                m(s, "tag-whitespace") ||
                m(s, "attribute-name") ||
                m(s, "attribute-equals") ||
                m(s, "attribute-value")
              )
            )
              return;
            if (m(s, "reference.attribute-value")) return;
            if (m(s, "attribute-value")) {
              var l = i.getCurrentTokenColumn() + s.value.length;
              if (a.column < l) return;
              if (a.column == l) {
                var u = i.stepForward();
                if (u && m(u, "attribute-value")) return;
                i.stepBackward();
              }
            }
            if (/^\s*>/.test(o.getLine(a.row).slice(a.column))) return;
            for (; !m(s, "tag-name"); )
              if ("<" == (s = i.stepBackward()).value) {
                s = i.stepForward();
                break;
              }
            var c = i.getCurrentTokenRow(),
              g = i.getCurrentTokenColumn();
            if (m(i.stepBackward(), "end-tag-open")) return;
            var d = s.value;
            if (
              (c == a.row && (d = d.substring(0, a.column - g)),
        ...
        this.add("autoindent", "insertion", function (e, t, n, o, r) {
          if ("\n" == r) {
            var a = n.getCursorPosition(),
              i = o.getLine(a.row),
              s = new p(o, a.row, a.column);
            if (
              (l = s.getCurrentToken()) &&
              -1 !== l.type.indexOf("tag-close")
            ) {
              if ("/>" == l.value) return;
              for (; l && -1 === l.type.indexOf("tag-name"); )
                l = s.stepBackward();
              if (!l) return;
              var l,
                u = l.value,
                c = s.getCurrentTokenRow();
              if (!(l = s.stepBackward()) || -1 !== l.type.indexOf("end-tag"))
                return;
              if (this.voidElements && !this.voidElements[u]) {
                var g = o.getTokenAt(a.row, a.column + 1),
                  i = o.getLine(c),
                  d = this.$getIndent(i),
                  m = d + o.getTabString();
                return g && "</" === g.value
    ...
    var r = e("../../lib/oop"),
      a = e("../behaviour").Behaviour,
      p = e("../../token_iterator").TokenIterator;
    e("../../lib/lang");
    r.inherits(o, a), (t.XmlBehaviour = o);
  }),
    ...
    (function () {
      (this.getFoldWidget = function (e, t, n) {
        ...
        (this._getFirstTagInLine = function (e, t) {
          for (var n = e.getTokens(t), o = new i(), r = 0; r < n.length; r++) {
            var a = n[r];
            if (l(a, "tag-open")) {
              if (
            ...
            if (l(a, "tag-close")) return (o.selfClosing = "/>" == a.value), o;
        ...
        (this.getFoldWidgetRange = function (e, t, n) {
          ...
          var r,
            a = [];
          if (o.closing || o.selfClosing) {
            for (
              var i = new c(e, n, o.end.column),
                s = { row: n, column: o.start.column };
              (r = this._readTagBackward(i));
              ...
              if (r.selfClosing) {
                if (!a.length)
                  return (
                    ...
                    (r.end.column -= 2),
                    u.fromPoints(r.start, r.end)
                  );
              } else if (r.closing) a.push(r);
              else if ((this._pop(a, r), 0 == a.length))
                return (
                  (r.start.column += r.tagName.length + 2),
                  r.start.row == r.end.row &&
                    r.start.column < r.end.column &&
                    (r.start.column = r.end.column),
                  u.fromPoints(r.start, s)
                );
          } else {
            var i = new c(e, n, o.start.column),
              l = { row: n, column: o.start.column + o.tagName.length + 2 };
            for (
              o.start.row == o.end.row && (l.column = o.end.column);
              (r = this._readTagForward(i));
              ...
              if (r.selfClosing) {
                ...
                if ((this._pop(a, r), 0 == a.length))
                  return u.fromPoints(l, r.start);
              } else a.push(r);
          }
        });
    }.call(a.prototype));
  ...
  define("ace/mode/xml", [
    ...
    r.inherits(o, i),
      function () {
        (this.voidElements = a.arrayToMap([])),
          (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
          (this.createWorker = function (t) {
            var e = new c(["ace"], "ace/mode/xml_worker", "Worker");
            return (
              e.attachToDocument(t.getDocument()),
  ...
  define("ace/mode/css_highlight_rules", [
    ...
    function o() {
      ...
      (this.$rules = {
        start: [
          ...
          { token: "constant.numeric", regex: g },
    ...
    var r = e("../lib/oop"),
      a = (e("../lib/lang"), e("./text_highlight_rules").TextHighlightRules),
      i = (t.supportType =
    ...
    r.inherits(o, a), (t.CssHighlightRules = o);
  }),
    ...
    (function () {
      (this.completionsDefined = !1),
        (this.defineCompletions = function () {
          if (document) {
            var e,
              t = document.createElement("c").style;
            for (var n in t) {
              "string" == typeof t[n] &&
                ((e = n.replace(/[A-Z]/g, function (e) {
                  return "-" + e.toLowerCase();
                })),
                s.hasOwnProperty(e) || (s[e] = 1));
            }
          }
        ...
        (this.getCompletions = function (e, t, n, o) {
          ...
          return /:[^;]+$/.test(r)
            ...
            : this.getPropertyCompletions(e, t, n, o);
        }),
        (this.getPropertyCompletions = function (e, t, n, o) {
        ...
        (this.getPropertyValueCompletions = function (e, t, n, o) {
          var r = t.getLine(n.row).substr(0, n.column),
            a = (/([\w\-]+):[^:]*$/.exec(r) || {})[1];
          if (!a) return [];
          var i = [];
          return (
            a in s && "object" == typeof s[a] && (i = Object.keys(s[a])),
            i.map(function (e) {
              return {
                caption: e,
                snippet: e,
  ...
  define("ace/mode/behaviour/css", [
      ...
      this.inherit(a),
        this.add("colon", "insertion", function (e, t, n, o, r) {
          if (":" === r && n.selection.isEmpty()) {
            var a = n.getCursorPosition(),
              i = new u(o, a.row, a.column),
              s = i.getCurrentToken();
            if (
              (s && s.value.match(/\s+/) && (s = i.stepBackward()),
              s && "support.type" === s.type)
            ) {
              var l = o.doc.getLine(a.row);
              if (":" === l.substring(a.column, a.column + 1))
                return { text: "", selection: [1, 1] };
              if (/^(\s+[^;]|\s*$)/.test(l.substring(a.column)))
                return { text: ":;", selection: [1, 1] };
            }
          }
        }),
        ...
        this.add("semicolon", "insertion", function (e, t, n, o, r) {
          if (";" === r && n.selection.isEmpty()) {
            var a = n.getCursorPosition();
            if (";" === o.doc.getLine(a.row).substring(a.column, a.column + 1))
              return { text: "", selection: [1, 1] };
          }
        }),
    ...
    var r = e("../../lib/oop"),
      a = (e("../behaviour").Behaviour, e("./cstyle").CstyleBehaviour),
      u = e("../../token_iterator").TokenIterator;
    r.inherits(o, a), (t.CssBehaviour = o);
  }),
  define("ace/mode/css", [
    "require",
    "exports",
    ...
    var r = e("../lib/oop"),
      ...
      s = e("./matching_brace_outdent").MatchingBraceOutdent,
      l = e("../worker/worker_client").WorkerClient,
      u = e("./css_completions").CssCompletions,
    ...
    r.inherits(o, a),
      function () {
        (this.foldingRules = "cStyle"),
          ...
          (this.createWorker = function (t) {
            var e = new l(["ace"], "ace/mode/css_worker", "Worker");
            return (
              e.attachToDocument(t.getDocument()),
              e.on("annotate", function (e) {
                t.setAnnotations(e.data);
    ...
    var o = e("../lib/oop"),
      ...
      u = function () {
        s.call(this),
          ...
          this.constructor === u && this.normalizeRules();
      };
    o.inherits(u, s), (t.HtmlHighlightRules = u);
  }),
  ...
  define("ace/mode/html_completions", [
    ...
    function l(e, t) {
      for (
        var n = new u(e, t.row, t.column), o = n.getCurrentToken();
        o && !s(o, "tag-name");
    ...
    (function () {
      (this.getCompletions = function (e, t, n, o) {
        ...
        (this.getAttributeCompletions = function (e, t, n, o) {
          ...
          var a = i;
          return (
            r in c && (a = a.concat(Object.keys(c[r]))),
            a.map(function (e) {
              return {
                caption: e,
                snippet: e + '="$0"',
        ...
        (this.getAttributeValueCompletions = function (e, t, n, o) {
          var r = l(t, n),
            a = (function (e, t) {
              for (
                var n = new u(e, t.row, t.column), o = n.getCurrentToken();
                o && !s(o, "attribute-name");
  ...
  define("ace/mode/html", [
    ...
    function o(e) {
      (this.fragmentContext = e && e.fragmentContext),
        ...
        this.createModeDelegates({ "js-": s, "css-": l }),
        (this.foldingRules = new g(this.voidElements, a.arrayToMap(h)));
    }
    var r = e("../lib/oop"),
      a = e("../lib/lang"),
      i = e("./text").Mode,
      ...
      g = e("./folding/html").FoldMode,
      d = e("./html_completions").HtmlCompletions,
      m = e("../worker/worker_client").WorkerClient,
      p = [
        "area",
        "base",
        "br",
    ...
    r.inherits(o, i),
      function () {
        (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
          (this.voidElements = a.arrayToMap(p)),
          (this.getNextLineIndent = function (e, t, n) {
          ...
          (this.createWorker = function (t) {
            if (this.constructor == o) {
              var e = new m(["ace"], "ace/mode/html_worker", "Worker");
              return (
                e.attachToDocument(t.getDocument()),
  ...
  define("ace/mode/markdown_highlight_rules", [
    ...
    function r() {
      ...
      var e = {
          token: "support.function",
          regex: /^\s*(```+[^`]*|~~~+[^~]*)$/,
          onMatch: function (e, t, n, o) {
            var r = e.match(/^(\s*)([`~]+)(.*)/),
              a = /[\w-]+|$/.exec(r[3])[0];
            return (
              c[a] || (a = ""),
              n.unshift("githubblock", [], [r[1], r[2], a], t),
              this.token
            );
          },
          next: "githubblock"
        ...
        t = [
          {
            ...
            onMatch: function (e, t, n, o) {
              ...
              if (
                l &&
                l[1].length < a.length + 3 &&
                l[2].length >= i.length &&
                l[2][0] == i[0]
              )
                return n.splice(0, 3), (this.next = n.shift()), this.token;
              if (((this.next = ""), s && c[s])) {
                var u = c[s].getTokenizer().getLineTokens(e, r.slice(0));
                return (n[1] = u.state), u.tokens;
              }
              return this.token;
            }
          }
    ...
    var c = e("../config").$modes,
      a = e("../lib/oop"),
      i = e("../lib/lang"),
      s = e("./text_highlight_rules").TextHighlightRules,
      l = e("./html_highlight_rules").HtmlHighlightRules;
    a.inherits(r, s), (t.MarkdownHighlightRules = r);
  }),
    ...
    o.inherits(a, r),
      function () {
        (this.foldingStartMarker = /^(?:[=-]+\s*$|#{1,6} |`{3})/),
          (this.getFoldWidget = function (e, t, n) {
            var o = e.getLine(n);
            return this.foldingStartMarker.test(o)
              ? "`" == o[0] && "start" == e.bgTokenizer.getState(n)
                ? "end"
                : "start"
              : "";
          }),
          (this.getFoldWidgetRange = function (t, e, n) {
            function o(e) {
              return (c = t.getTokens(e)[0]) && 0 === c.type.lastIndexOf(g, 0);
            }
            function r() {
              var e = c.value[0];
              return "=" == e ? 6 : "-" == e ? 5 : 7 - c.value.search(/[^#]|$/);
            }
            var a = t.getLine(n),
              i = a.length,
              s = t.getLength(),
              l = n,
              u = n;
            if (a.match(this.foldingStartMarker)) {
              if ("`" == a[0]) {
                if ("start" !== t.bgTokenizer.getState(n)) {
                  for (
                    ;
                    ++n < s &&
                    !(
              ...
              if (o(n)) {
                ...
                if (
                  l <
                  (u = n - (c && -1 != ["=", "-"].indexOf(c.value[0]) ? 2 : 1))
                )
                  for (; l < u && /^\s*$/.test(t.getLine(u)); ) u--;
                if (l < u) {
                  var m = t.getLine(u).length;
                  return new p(l, i, u, m);
                }
              }
            }
          });
  ...
  define("ace/mode/sh_highlight_rules", [
      ...
      (this.$rules = {
        start: [
          ...
          { regex: "<<<", token: "keyword.operator" },
          {
            ...
            regex: "(<<-?)(\\s*)(['\"`]?)([\\w\\-]+)(['\"`]?)",
            onMatch: function (e, t, n) {
              var o = "-" == e[2] ? "indentedHeredoc" : "heredoc",
                r = e.split(this.splitRegex);
              return (
                n.push(o, r[4]),
                [
                  { type: "constant", value: r[1] },
                  { type: "text", value: r[2] },
                  { type: "string", value: r[3] },
                  { type: "support.class", value: r[4] },
                  { type: "string", value: r[5] }
                ]
              );
            },
            rules: {
          ...
          },
          {
            ...
            token: "empty",
            next: function (e, t) {
              return "heredoc" === t[0] || "indentedHeredoc" === t[0]
                ? t[0]
                : e;
            }
          },
    ...
    r.inherits(o, a), (t.ShHighlightRules = o);
  }),
  define("ace/mode/sh", [
    "require",
    "exports",
    ...
    r.inherits(o, a),
      function () {
        ...
        (this.checkOutdent = function (e, t, n) {
          if ("\r\n" !== n && "\r" !== n && "\n" !== n) return !1;
          var o = this.getTokenizer().getLineTokens(t.trim(), e).tokens;
          if (!o) return !1;
          do {
            var r = o.pop();
          } while (
            r &&
            ("comment" == r.type ||
              ("text" == r.type && r.value.match(/^\s+$/)))
          );
          return !!r && "keyword" == r.type && a[r.value];
        }),
          (this.autoOutdent = function (e, t, n) {
            n += 1;
            var o = this.$getIndent(t.getLine(n)),
              r = t.getTabString();
            o.slice(-r.length) == r &&
              t.remove(new s(n, o.length - r.length, n, o.length));
          }),
          (this.$id = "ace/mode/sh"),
  ...
  define("ace/mode/markdown", [
    ...
    var r = e("../lib/oop"),
      ...
      i =
        ...
        e("./xml").Mode,
        e("./html").Mode,
        e("./markdown_highlight_rules").MarkdownHighlightRules),
      s = e("./folding/markdown").FoldMode;
    r.inherits(o, a),
      function () {
        (this.type = "text"),
          (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
          (this.$quotes = { '"': '"', "`": "`" }),
          (this.getNextLineIndent = function (e, t, n) {
            if ("listblock" != e) return this.$getIndent(t);
            var o = /^(\s*)(?:([-+*])|(\d+)\.)(\s+)/.exec(t);
            if (!o) return "";
            var r = (r = o[2]) || parseInt(o[3], 10) + 1 + ".";
            return o[1] + r + o[4];
          }),
  ...
  window.require(["ace/mode/markdown"], function (e) {
