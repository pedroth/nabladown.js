...
function parseStatement(stream) {
  return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
    ...
    var _parseList = parseList(0)(stream),
        List = _parseList.left,
        nextStream = _parseList.right;
...
function parseList(n) {
  return function (stream) {
    return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
      // order matters
      var stream1 = Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
        return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["eatSymbol"])(2 * n, function (s) {
          return s.peek().text === " ";
        })(stream);
      }, function () {
        return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["eatSymbol"])(n, function (s) {
          return s.peek().text === " ";
        })(stream);
      });

      var _parseListItem = parseListItem(n)(stream1),
          ListItem = _parseListItem.left,
          stream2 = _parseListItem.right;

      var _parseList2 = parseList(n)(stream2),
          List = _parseList2.left,
          stream3 = _parseList2.right;

      return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["pair"])({
        type: "list",
        list: [ListItem].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(List.list))
      }, stream3);
    }, function () {
      return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["pair"])({
        type: "list",
...
function parseListItem(n) {
  return function (stream) {
    var token = stream.peek().text;

    if (token === "-" || token === "*") {
      var _parseSeq3 = parseSeq(stream.next()),
          Seq = _parseSeq3.left,
          stream1 = _parseSeq3.right;

      var token1 = stream1.peek().text;

      if (token1 === "\n") {
        var _parseList3 = parseList(n + 1)(stream1.next()),
            List = _parseList3.left,
            stream2 = _parseList3.right;

        return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["pair"])({
          type: "listItem",
          Seq: Seq,
          children: Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(List.list)
        }, stream2);
      }
    }
...
function parseSeq(stream) {
  return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
    ...
    var _parseSeq4 = parseSeq(nextStream),
        Seq = _parseSeq4.left,
        nextNextStream = _parseSeq4.right;
...
function parseSeqTypes(stream) {
  return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
    ...
    var _parseMedia = parseMedia(stream),
        Media = _parseMedia.left,
        nextStream = _parseMedia.right;
...
function parseText(stream) {
  return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
    var _parseAnyBut = parseAnyBut(function (t) {
      return ["$", "+", "`", "[", "*", "\n"].includes(t.type);
    })(stream),
        AnyBut = _parseAnyBut.left,
        nextStream = _parseAnyBut.right;

    if (AnyBut.textArray.length > 0) {
      return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["pair"])({
        type: "text",
        text: AnyBut.textArray.join("")
      }, nextStream);
    }

    throw new Error("Error occurred while parsing Text," + stream.toString());
  }, function () {
    var _parseSingle = parseSingle(function (t) {
      return t.type === "\n";
    })(stream),
        Single = _parseSingle.left,
        nextStream = _parseSingle.right;
  ...
  if (token.type === "$") {
    var _parseAnyBut2 = parseAnyBut(function (token) {
      return ["$"].includes(token.type);
        ...
        _nextStream4 = _parseAnyBut2.right;
  ...
  if (lineCodeTokenPredicate(token)) {
    var _parseAnyBut4 = parseAnyBut(function (t) {
      return lineCodeTokenPredicate(t) || t.type === "\n";
        ...
        AnyBut = _parseAnyBut4.left,
        _nextStream6 = _parseAnyBut4.right;
...
function parseBlockCode(stream) {
  ...
  if (lineCodeTokenPredicate(token)) {
    var _parseAnyBut5 = parseAnyBut(function (t) {
      return t.type === "\n";
    })(stream.next()),
        languageAnyBut = _parseAnyBut5.left,
        _nextStream7 = _parseAnyBut5.right;

    var _parseAnyBut6 = parseAnyBut(lineCodeTokenPredicate)(_nextStream7.next()),
        AnyBut = _parseAnyBut6.left,
        nextNextStream = _parseAnyBut6.right;
  ...
  return function (stream) {
    return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
      ...
      if (!tokenPredicate(peek)) {
        var _parseAnyBut7 = parseAnyBut(tokenPredicate)(stream.next()),
            AnyBut = _parseAnyBut7.left,
            _nextStream8 = _parseAnyBut7.right;
      ...
      if (next3Stream.peek().type === "(") {
        var _parseAnyBut8 = parseAnyBut(function (token) {
          return ["\n", ")"].includes(token.type);
            ...
            next4Stream = _parseAnyBut8.right;
...
function parseMedia(stream) {
  // ugly
  if (stream.peek().type === "!") {
    var _nextStream10 = stream.next();

    if (_nextStream10.peek().type === "[") {
      var _parseLinkStat2 = parseLinkStat(_nextStream10.next()),
      ...
      if (nextNextStream.peek().type === "]") {
        ...
        if (next3Stream.peek().type === "(") {
          var _parseAnyBut9 = parseAnyBut(function (token) {
            return ["\n", ")"].includes(token.type);
          })(next3Stream.next()),
              AnyBut = _parseAnyBut9.left,
              next4Stream = _parseAnyBut9.right;
...
function parseLinkStat(stream) {
  return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
    var _parseLinkType = parseLinkType(stream),
        LinkType = _parseLinkType.left,
        nextStream = _parseLinkType.right;
...
function parseLinkType(stream) {
  return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
    ...
    var _parseHtml2 = parseHtml(stream),
        Html = _parseHtml2.left,
        nextStream = _parseHtml2.right;
    ...
    var _parseCode2 = parseCode(stream),
        Code = _parseCode2.left,
        nextStream = _parseCode2.right;
    ...
    var _parseItalic2 = parseItalic(stream),
        Italic = _parseItalic2.left,
        nextStream = _parseItalic2.right;
    ...
    var _parseBold2 = parseBold(stream),
        Bold = _parseBold2.left,
        nextStream = _parseBold2.right;
    ...
    var _parseSingle2 = parseSingle(function (token) {
      return ["\n", "]"].includes(token.type);
    })(stream),
        Single = _parseSingle2.left,
        nextStream = _parseSingle2.right;
