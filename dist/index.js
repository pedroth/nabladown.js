  ...
  return function (stream) {
    return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
      ...
      if (!tokenPredicate(peek)) {
        var _parseAnyBut3 = parseAnyBut(tokenPredicate)(stream.next()),
...
function parseLink(stream) {
  // ugly
  if (stream.peek().type === "[") {
    var _nextStream7 = stream.next();

    var _parseLinkStat = parseLinkStat(_nextStream7),
    ...
    if (nextNextStream.peek().type === "]") {
      ...
      if (next3Stream.peek().type === "(") {
        var _parseAnyBut4 = parseAnyBut(function (token) {
          return ["\n", ")"].includes(token.type);
        })(next3Stream.next()),
            AnyBut = _parseAnyBut4.left,
            next4Stream = _parseAnyBut4.right;
    ...
    return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
      ...
      var _parseAnyBut5 = parseAnyBut(function (token) {
        return ["\n", "]"].includes(token.type);
          ...
          nextStream = _parseAnyBut5.right;
...
function renderHtml(html) {
  ...
  Array.from(div.getElementsByTagName("script")).forEach(function (script) {
...
/*!**********************!*\
  !*** ./src/Utils.js ***!
  \**********************/
/*! exports provided: pair, stream, or, returnOne, evalScriptTag, functionEncode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function stream(stringOrArray) {
  ...
  var array = Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(stringOrArray);
...
function evalScriptTag(scriptTag) {
  ...
  if (!!srcUrl) {
    fetch(srcUrl).then(function (code) {
      return code.text();
    }).then(function (code) {
