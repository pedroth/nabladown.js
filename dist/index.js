(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["NablaDown"] = factory();
	else
		root["NablaDown"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/nabladown.js");
/******/ })
/************************************************************************/
/******/ ({
  ...
  return function (stream) {
    return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
      ...
      if (!tokenPredicate(peek)) {
        var _parseAnyBut4 = parseAnyBut(tokenPredicate)(stream.next()),
...
function parseLink(stream) {
  // ugly
  if (stream.peek().type === "[") {
    var _nextStream8 = stream.next();

    var _parseLinkStat = parseLinkStat(_nextStream8),
    ...
    if (nextNextStream.peek().type === "]") {
      ...
      if (next3Stream.peek().type === "(") {
        var _parseAnyBut5 = parseAnyBut(function (token) {
          return ["\n", ")"].includes(token.type);
        })(next3Stream.next()),
            AnyBut = _parseAnyBut5.left,
            next4Stream = _parseAnyBut5.right;
...
function parseLinkStat(stream) {
  return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
    return Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["or"])(function () {
      ...
      var _parseAnyBut6 = parseAnyBut(function (token) {
        return ["\n", "]"].includes(token.type);
      })(stream),
          AnyBut = _parseAnyBut6.left,
          nextStream = _parseAnyBut6.right;
...
function renderStatement(statement) {
  return Object(_Utils__WEBPACK_IMPORTED_MODULE_3__["returnOne"])([{
...
function renderHtml(html) {
  ...
  var asyncLambdas = scripts.map(function (script) {
    return function () {
      return Object(_Utils__WEBPACK_IMPORTED_MODULE_3__["evalScriptTag"])(script);
    };
  });
  Object(_Utils__WEBPACK_IMPORTED_MODULE_3__["asyncForEach"])(asyncLambdas);
  return div;
}
/**
 * code => HTML
...
function renderLineCode(lineCode) {
  ...
  pre.setAttribute("style", "border-style: solid; border-width: thin; border-radius: 5px;background-color: rgba(0,0,0,0.8);color: orange;border: hidden;");
  pre.innerText = code;
  return pre;
}
/**
...
function renderBlockCode(blockCode) {
  ...
  var div = document.createElement("div");
  div.setAttribute("style", "border-style: solid; border-width: thin; border-radius: 5px;background-color: rgba(0,0,0,0.8);color: orange;");
  var pre = document.createElement("pre");
  pre.innerText = code;
  div.appendChild(pre);
  return div;
...
function renderAuxLinkStat(linkStat) {
  ...
  var linkStatTypesDiv = Object(_Utils__WEBPACK_IMPORTED_MODULE_3__["returnOne"])([{
  ...
  }], document.createElement("div"))(linkStat);
  var linkStatDivArray = renderAuxSeq(linkStat.LinkStat);
  return [linkStatTypesDiv].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(linkStatDivArray));
}
...
/*!**************************!*\
  !*** ./src/nabladown.js ***!
  \**************************/
/*! exports provided: parse, render */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Parser */ "./src/Parser.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "parse", function() { return _Parser__WEBPACK_IMPORTED_MODULE_0__["parse"]; });
