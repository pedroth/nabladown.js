          ...
          function (e, t, n) {
            (function (e) {
              ...
              var r = 200,
                ...
                B = /^(?:0|[1-9]\d*)$/,
                j = {};
              (j[o] = j[u] = j[S] = j[x] = j[a] = j[f] = j[T] = j[N] = j[C] = j[
                k
              ] = j[L] = j[p] = j[d] = j[v] = j[g] = j[y] = j[b] = j[w] = j[
                A
              ] = j[O] = j[M] = j[_] = !0),
                (j[l] = j[c] = j[E] = !1);
          ...
          function (e, t, n) {
            ...
            var r = e("underscore"),
              i = {
                ...
                E053:
                  "{a} declarations are only allowed at the top level of module scope.",
                E054:
                ...
                E059:
                  "Incompatible values for the '{a}' and '{b}' linting options.",
                E060:
                  "Non-callable values cannot be used as the second operand to instanceof.",
                E061:
                ...
                E066:
                  "Asynchronous iteration is only available with for-of loops."
              },
              s = {
                ...
                W124:
                  "A generator function should contain at least one yield expression.",
                W125:
                ...
                W137:
                  "Empty destructuring: this is unnecessary and can be removed.",
                W138:
                  "Regular parameters should not come after default parameters.",
                W139:
                  "Function expressions should not be used as the second operand to instanceof.",
                W140: "Missing comma.",
                ...
                W144:
                  "'{a}' is a non-standard language feature. Enable it using the '{b}' unstable option.",
